...
{
public:
    UI() : margin({0,0,0,0}), flex_grow(1), align_self(UI_ALIGN_UNSET), expand_h(false), expand_v(false), cached_sr_valid{false, false}, m_parent(nullptr), m_min_size{0,0}, m_max_size{INT_MAX, INT_MAX} {};
    ~UI() {
